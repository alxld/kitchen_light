...
#        self.harmony_on = False
        ...
        _LOGGER.info("KitchenLight initialized")
...
#        return data
    ...
    async def async_turn_on(self, **kwargs) -> None:
        ...
        brightness control.
        """
        _LOGGER.error(f"KITCHEN_LIGHT ASYNC_TURN_ON: {kwargs}")
...
#        )
    ...
    async def async_update(self):
        ...
        _LOGGER.error("KITCHEN_LIGHT ASYNC_UPDATE")
